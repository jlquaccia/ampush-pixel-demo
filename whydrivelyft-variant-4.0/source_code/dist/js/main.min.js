...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ctaHome = __webpack_require__(376);

	var _form = __webpack_require__(377);

	var _smoothScroll = __webpack_require__(10);

	var _verify = __webpack_require__(379);

	var _utmTracker = __webpack_require__(8);

	var _customTracker = __webpack_require__(12);

	var _gotoTop = __webpack_require__(15);

	var _accordian = __webpack_require__(380);

	var _fullStoryInit = __webpack_require__(18);

	var _bonus = __webpack_require__(14);

	var _tracker = __webpack_require__(20);

	var _countdownTimer = __webpack_require__(381);

	var _signupForm = __webpack_require__(21);

	var _signupformFloating = __webpack_require__(349);

	var _utmApi = __webpack_require__(13);

	var utmAPI = _interopRequireWildcard(_utmApi);

	var _activeNav = __webpack_require__(350);
	 ...
	 */
	function Lyft() {
	  new _tracker.firePixelTracker();
	  new _customTracker.customTracker();
	  new _accordian.questionsAccordian();
	  new _activeNav.activeNav();
	  var intervalObj = setInterval(function () {
	    if (window.isTrackerLoad) {
	      new _utmTracker.utmTracker();
	  ...
	  setTimeout(function () {
	    if (window._fs_namespace !== 'FS') {
	      new _fullStoryInit.fullStoryInit();
	    }
	  }, 500);
	...
	window.initAutoComplete = function () {
	  ...
	  regionEl.addEventListener("keydown", function (e) {
	    if (e.keyCode === 40) {
	      hasDownBeenPressed = true;
	    }
	  });
	  // GoogleMaps API custom eventlistener method
	  google.maps.event.addDomListener(regionEl, "blur", function (e) {
	  ...
	  // GoogleMaps API custom eventlistener method
	  google.maps.event.addDomListener(regionEl, "keydown", function (e) {
	    // Maps API e.stopPropagation();
	    e.cancelBubble = true;
	  ...
	  autoComplete.addListener('place_changed', function () {
	    ...
	    var formattedSelectedCity = window.cityName.replace(/,/g, '').replace(/\s+/g, '-').toString();
	...
	window.initAutoCompleteSignUpFloating = function () {
	  ...
	  var regionEl = document.getElementById('signup-region');
	  var latEl = document.getElementById('signup-lat');
	  var lngEl = document.getElementById('signup-lng');
	  var selectedCityName = void 0;
	  var options = {
	    componentRestrictions: { country: 'us' },
	    types: ['(cities)']
...
/***/ (function(module, exports) {
	...
	function stickyNav() {
	  window.onscroll = function () {
	    var promoBanner = document.getElementsByClassName('promo-banner')[0];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.utmTracker = utmTracker;

	var _utmVariants = __webpack_require__(9);

	var utmVariants = _interopRequireWildcard(_utmVariants);
	...
	var utmVariantsObj = utmVariants.default;
	var currentVariant = location.href.split('/').splice(3).join('/').split('?')[0].toString();
	...
	var domain = location.hostname === 'www.whydrivelyft.com' || location.hostname === 'try.whydrivelyft.com' ? '.whydrivelyft.com' : 'localhost'; // handles setting utm cookies in development
	var codeId = document.getElementById('code');
	var signupCodeId = document.getElementById('signup-code');

	var tracker_IE = ""; //PERF-448 fix.
	var queryString = void 0;

	function utmTracker() {
	  if (location.pathname.indexOf('index.html') == -1 && location.pathname.indexOf('index-') == -1) {
	    //if page is Something other than index.html or index personal pages change to content
	  ...
	  function setQueryStringParamsOnRefresh() {
	    ...
	    if (result.code) {
	      ...
	      var cookieValue = getCookieValue('code');
	    ...
	    if (result.utm_campaign) {
	      ...
	      var _cookieValue = getCookieValue('utm_campaign');
	      if (!_cookieValue) {
	        _cookieValue = DefaultParams.UTM_CAMPAIGN;
	      }
	      setCookie('utm_campaign=' + _cookieValue, false);
	    }
	    ...
	    if (result.cvosrc) {
	      ...
	      var _cookieValue2 = getCookieValue('cvosrc');
	      if (!_cookieValue2) {
	        _cookieValue2 = DefaultParams.CVOSRC + DefaultParams.UTM_CAMPAIGN;
	      }
	      setCookie('cvosrc=' + _cookieValue2, false);
	    }
	    ...
	    if (result.adgroup) {
	      ...
	      var _cookieValue3 = getCookieValue('adgroup');
	      if (!_cookieValue3) {
	        _cookieValue3 = DefaultParams.ADGROUP;
	      }
	      setCookie('adgroup=' + _cookieValue3, false);
	    }
	    ...
	    if (result.ad) {
	      ...
	      var _cookieValue4 = getCookieValue('ad');
	      if (!_cookieValue4) {
	        _cookieValue4 = DefaultParams.AD;
	      }
	      setCookie('ad=' + _cookieValue4, false);
	    }
	    ...
	    if (result.utm_source !== DefaultParams.UTM_SOURCE && result.utm_source !== undefined) {
	      ...
	      var _cookieValue5 = getCookieValue('utm_source');
	      if (!_cookieValue5) {
	        _cookieValue5 = DefaultParams.UTM_SOURCE;
	      }
	      setCookie('utm_source=' + _cookieValue5, false);
	    }
	    ...
	    if (result.utm_aid) {
	      ...
	      var _cookieValue6 = getCookieValue('utm_aid');
	      if (!_cookieValue6) {
	        _cookieValue6 = DefaultParams.UTM_AID;
	      }
	      setCookie('utm_aid=' + _cookieValue6, false);
	    }
	    ...
	    if (result.utm_content) {
	      ...
	      var _cookieValue7 = getCookieValue('utm_content');
	      if (!_cookieValue7) {
	        _cookieValue7 = DefaultParams.UTM_CONTENT;
	      }
	      setCookie('utm_content=' + _cookieValue7, false);
	    }
	...
	function validateUTMContentAndSetCookies() {
	  ...
	  if (utm_content_val && (utm_content_val.split('-')[0] === getCookieValue('amptuid') || utm_content_val.split('-')[0] === getCookieValue('amptuid').split('-')[0])) {
	    /* If Amptuid is already appended to utm_content*/
	    setDefaultParameters();
	    setParamsToLinks();
	  } else if (!/^amp_/i.test(utm_content_val)) {
	    /* If UTM_content is not encrypted*/
	    if (utm_content_val != '') {
	    ...
	    /* If UTM_content is encrypted just concatenate with amptuid*/
	...
	function setDefaultParameters() {
	  var temp_string = getCookie().split("; ").filter(function (s) {
	    return s != '';
	  });
	...
	function hasValidUTMSource() {
	  ...
	  if (!validFlag) {
	    queryString = getCookie().split("; ").filter(function (s) {
	      return s != '';
	    }).join("&");
	  }
	}
	...
	function encodeUTMParameter(utm_campaign_val, callbackFunction) {
	  ...
	  xhttp.open('POST', 'https://ampid.ampush.io/translate?id=' + utm_campaign_val, true);
	...
	function setParamsToLinks() {
	  ...
	  validatedParams = validatedParams.filter(function (s) {
	    return s != '';
	  }).join('&'); //to remove extra space getting added while saving in cookies in production
	  ...
	  for (var i = 0; i < anchorEls.length; i++) {
	    anchorEls[i].href = /\?$/.test(anchorEls[i].href) ? anchorEls[i].href + validatedParams : anchorEls[i].href + '&' + validatedParams;
	  }
	...
	function reorderQueryString(validatedParams) {
	  ...
	  for (var _i = 1; _i < ParamDefaultOrder.length; _i++) {
	    newQueryString = newQueryString + "&" + ParamDefaultOrder[_i] + "=" + tempArray[ParamDefaultOrder[_i]];
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function smoothScroll() {
	  ...
	  function handleScroll(e) {
	    e.stopPropagation();
	    e.preventDefault();
	    (0, _jump.jump)(this.getAttribute('href'), {
	      duration: 500
	    });
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.customTracker = customTracker;
	...
	function customTracker() {
	  var trackerClass = document.getElementsByClassName('track');
	  if (trackerClass) {
	    for (var i = 0; i < trackerClass.length; i++) {
	  ...
	  function handleTrackerTag(e) {
	    ...
	    var dataTrack1 = e.target.getAttribute('data-track1');
	    var safariDataTrack1 = e.target.getAttribute('safari-data-track1');
	    dataTrack1 == undefined ? dataTrack1 = e.target.ownerDocument.activeElement.getAttribute('data-track1') : "";
	    var dataTrack2 = e.target.getAttribute('data-track2');
	    var buttonTrack = e.target.getAttribute('button-track');
	    var safariButtonTrack = e.target.getAttribute('safari-button-track');
	    var buttonTrack2 = e.target.getAttribute('button-track2');
	    ...
	    if (dataTrack1 && dataTrack2) {
	      ...
	      /* CTA button clicks trigger Ampush-custom-event and Facebook Event*/
...
/***/ (function(module, exports) {
	...
	var utmAPI = {
	  getUtmParams: function getUtmParams(customParamsObj) {
	    // ex. customParamsObj
	    // {propName: 'value'}
	    ...
	    if (customParamsObj) {
	      for (var prop in customParamsObj) {
	        key = prop;
...
/***/ (function(module, exports) {
	...
	function bonus() {
	    ...
	    var bonus = void 0;var days = void 0;var rides = void 0;var temp = void 0;
	    ...
	    if (document.getElementById("bonus") && document.getElementById("bonus-a") && document.getElementById("days")) {
	        /* only applicable to testimonial pages */
	        ...
	        var anchor = document.getElementById("seeTerms");
...
/***/ (function(module, exports) {
	...
	var scrollToTop = document.getElementsByClassName(ScrollerClasses.SCROLL_ICON)[0];
	/**
...
/***/ (function(module, exports) {
	...
	var fullStoryInit = exports.fullStoryInit = function fullStoryInit() {
	  var experimenterUrl;
...
/***/ (function(module, exports) {
	...
	exports.firePixelTracker = firePixelTracker;

	/**
	 * Ampush/Safari pixel tracker.
	 */
	function firePixelTracker() {
	  // let initiative;
	  // let pid;
	  //
	  ...
	  // t.onload=function(){ampt.init("lyft", "ce4c0c2b8-3c40-4963-9164-198a13f7689e");window.isTrackerLoad = true;safariAmpt.init(pid, initiative);window.isSafariTrackerLoad = true;};
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _formatNumberSignup = __webpack_require__(22);

	var _pixelTracker = __webpack_require__(23);
	...
	function SignUpForm() {
	  ...
	  var checkValidations = function () {
	    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
	      var isValidData, userData, userInputobj, value, inputEls, latEl, lngEl, _i, emailStatus, url, queryStringObj, xhttp;
	        ...
	        while (1) {
	          switch (_context.prev = _context.next) {
	            case 0:
	              ...
	              isValidData = [];
	              userData = '{}';
	              userInputobj = JSON.parse(userData);
	              value = phoneEl.value.replace(/\D/g, '');
	              inputEls = document.querySelectorAll('.signup__field');
	              latEl = document.getElementById('signup-lat');
	              lngEl = document.getElementById('signup-lng');
	            ...
	            case 10:
	              if (!(_i < inputEls.length)) {
	                _context.next = 29;
	                break;
	              }

	              if (!(inputEls[_i].value === '' && inputEls[_i].id != 'signup-code' && inputEls[_i].id != 'signup-region')) {
	                _context.next = 16;
	                break;
	              }

	              addErrClass(inputEls[_i]);
	              isValidData.push(false);
	              _context.next = 24;
	              break;

	            case 16:
	              if (!(inputEls[_i].id == 'email')) {
	                _context.next = 23;
	                break;
	              }

	              _context.next = 19;
	              return checkValidEmail(inputEls[_i]);
	            ...
	            case 19:
	              ...
	              if (!emailStatus) {
	                ...
	                userInputobj[inputEls[_i].name] = inputEls[_i].value;
	              }
	              _context.next = 24;
	              break;

	            case 23:
	              if (inputEls[_i].id == 'signup-region') {
	                // Validation whether signup-region selected from maps api.
	                if (window.isCitySelected && window.cityName === inputEls[_i].value) {
	              ...
	              } else if (inputEls[_i].id == 'signup-code') {
	                userInputobj[inputEls[_i].name] = inputEls[_i].value;
	              } else {
	                userInputobj[inputEls[_i].name] = inputEls[_i].value;
	              }
	            ...
	            case 24:
	              inputEls[_i].addEventListener('keyup', watchInput);
	              inputEls[_i].addEventListener('keydown', function () {
	            ...
	            case 29:
	              ...
	              queryStringObj = JSON.parse('{"' + decodeURI(url).replace(/"/g, '\\"').replace(/&/g, '","').replace(/=/g, '":"') + '"}');
	                ...
	                xhttp.onload = function () {
	                  if (xhttp.status == 200) {
	                    if (JSON.parse(xhttp.response).status) {
	                      var phoneElValue = phoneEl.value;
	    ...
	    return function checkValidations(_x) {
	  ...
	  var checkValidEmail = function () {
	      ...
	      return regeneratorRuntime.wrap(function _callee2$(_context2) {
	        while (1) {
	          switch (_context2.prev = _context2.next) {
	            ...
	            case 6:
	              _context2.next = 8;
	              return emailPromise(element.value);
	    ...
	    return function checkValidEmail(_x2) {
	  ...
	  var inputEls = document.getElementsByClassName('signup__field');
	  var phoneEl = document.getElementById('signup-phone');
	  var agreeTermsEl = document.getElementsByClassName('signup__agree')[0];
	  var submitBtn = document.getElementsByClassName('signup__btn-submit')[0];
	  var checkBoxEl = document.getElementById('agree-signup-terms');
	  var telNumber = 0;
	  var isNumberValid = false;
	  var emailObj = {};
	  var typeingTimer = void 0;
	  ...
	  for (var i = 0; i < inputEls.length; i++) {
	    if (inputEls[i].value !== "") {
	      var label = inputEls[i].previousSibling;
	  ...
	  new _formatNumberSignup.formatNumberSignUp(phoneEl);

	  function validateCheckBox() {
	    createSpan();
	    var errorEl = document.getElementsByClassName(FormClasses.AGREE_ERR)[0];
	    if (errorEl) {
	   ...
	   */
	  function createSpan() {
	    if (!checkBoxEl.checked && !document.getElementsByClassName(FormClasses.AGREE_ERR)[0]) {
	  ...
	  function updateElement(element) {
	    ...
	    var phone = userInputobj.phone.replace(/[^\d]/g, '');
	    var body = {
	    ...
	    var url = 'https://www.lyft.com/api/driverapplicant';
	    var successRedir = 'https://www.lyft.com/drivers/apply/step/verify-phone';
	    var failedRedir = 'https://www.lyft.com/auth?next=https://www.lyft.com/drivers/apply/resume&pn=1' + phone;
	  ...
	  function watchInput(e) {
	    switch (e.target.id) {
	      ...
	      case 'email':
	        clearTimeout(typeingTimer);
	        typeingTimer = setTimeout(function () {
	          checkValidEmail(e.target);
	        }, 1000);
	        break;
	      case 'signup-region':
	        updateState(e.target);
	  ...
	  function emailPromise(element) {
	    return new Promise(function (resolve, reject) {
	      ...
	      var xhttp = new XMLHttpRequest();
	      var url = location.hostname === 'www.whydrivelyft.com' || location.hostname === 'try.whydrivelyft.com' ? 'https://payments.ampush.io/validate/email?noerrors=1' : 'https://payments.ampush.io/validate/email';

	      xhttp.open('POST', url, true);

	      xhttp.onerror = xhttp.ontimeout = xhttp.onload = function () {
	        if (xhttp.readyState === 4 && xhttp.status !== 0) {
	          // check to make sure the payments email validation api isn't down
	          if (xhttp.status === 200) {
...
/***/ (function(module, exports) {
	...
	exports.formatNumberSignUp = formatNumberSignUp;
	/**
	 * Input field error class.
	 * @private {string}
	 */
	var ERROR_CLASS = 'signup__field--err';

	/**
	 * Input field error class.
	 * @private {string}
	 */
	var DIGITS_ONLY_REGEX = /\D/g;
	 ...
	 */
	function formatNumberSignUp(inputEl) {
	  var acceptOneOnce = '';
	  var storeOtherKeys = '';
	  var isPlusOneFormat = false;
	  ...
	  function checkKey(e) {
	    ...
	    var value = e.target.value.replace(DIGITS_ONLY_REGEX, '');
	    var newValue = '';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function trackPixel() {
	  ...
	  // fbq('trackCustom', 'BecomeDriverCTA');
	  //
	  // /* ---------------------------------------------------------------------------------------------------------------------------------- */
	  // /* ---------------------------------------------------------------------------------------------------------------------------------- */
	  // /* ---------------------------------------------------------------------------------------------------------------------------------- */
	  //
	  // //Ampush & Safari Pixel tracking
	  // ampt.track('ApplyBecomeADriver', utmAPI.default.getUtmParams());
	  // safariAmpt.track('leadsubmission', utmAPI.default.getUtmParams());
	  //
	  // /* ---------------------------------------------------------------------------------------------------------------------------------- */
	  // /* ---------------------------------------------------------------------------------------------------------------------------------- */
	  // /* ---------------------------------------------------------------------------------------------------------------------------------- */
	  //
	  // // Google #1
	  // function googlePixelOne() {
	  //   /* <![CDATA[ */
	  //   let google_conversion_id = 843009749;
	  //   let google_conversion_language = "en";
	  //   let google_conversion_format = "3";
	  //   let google_conversion_color = "ffffff";
	  //   let google_conversion_label = "-eyLCPTlrHUQ1Z39kQM";
	  ...
	  //
	  // // Google #2
	  // function googlePixelTwo() {
	  //   // Google Code for Hyperlink Click Conversion Page
	  //   /* <![CDATA[ */
	  //   var google_conversion_id = 843009749;
	  //   var google_conversion_language = "en";
	  //   var google_conversion_format = "3";
	  //   var google_conversion_color = "ffffff";
	  //   var google_conversion_label = "yqHWCPCPwnUQ1Z39kQM";
	  ...
	  //
	  // // Google #3
	  // function googlePixelThree() {
	  //   // Google Code for WDL Leads Conversion Page
	  //   /* <![CDATA[ */
	  //   var google_conversion_id = 818698887;
	  //   var google_conversion_label = "_rkwCOP_tXwQh7WxhgM";
	  //   var google_remarketing_only = false;
	  //   /* ]]> */
	  //   var image = new Image(1, 1);
	  //   image.src = "//www.googleadservices.com/pagead/conversion/" + google_conversion_id + "/?label=" + google_conversion_label + "&amp;guid=ON&amp;script=0";
	  ...
	  // /* ---------------------------------------------------------------------------------------------------------------------------------- */
	  //
	  // // Ampush Bing Pixel Code - Driver Lead -->
	  // (function(w,d,t,r,u){var f,n,i;w[u]=w[u]||[],f=function(){var o={ti:"5707160"};o.q=w[u],w[u]=new
	  // UET(o),w[u].push("pageLoad")},n=d.createElement(t),n.src=r,n.async=1,n.onload=n.onreadystatechange=function(){var
	  // s=this.readyState;s&&s!=="loaded"&&s!=="complete"||(f(),n.onload=n.onreadystatechange=null)},i=d.getElementsByTagName(t)[0],i.parentNode.
	  // insertBefore(n,i)})(window,document,"script","//bat.bing.com/bat.js","uetq");
	  // // DO NOT MODIFY End Ampush Bing Pixel Code - Driver Lead -->
	  //
	  // /* ---------------------------------------------------------------------------------------------------------------------------------- */
	  // /* ---------------------------------------------------------------------------------------------------------------------------------- */
	  // /* ---------------------------------------------------------------------------------------------------------------------------------- */
	  //
	  // // Ampush Yahoo Gemini Pixel Code - Driver Lead -->
	  // (function(w,d,t,r,u){w[u]=w[u]||[];w[u].push({'projectId':'10000','properties':{'pixelId':'10035687'}});var s=d.createElement(t);s.src=r;s.async=true;s.onload=s.onreadystatechange=function(){var
	  //   y,rs=this.readyState,c=w[u];if(rs&&rs!="complete"&&rs!="loaded"){return}try{y=YAHOO.ywa.I13N.fireBeacon;w[u]=[];w[u].push=function(p){y([p])};y(c)}catch(e){}};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	$export($export.S + $export.F * !__webpack_require__(29), 'Object', { defineProperties: __webpack_require__(69) });
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function (test, buggy, set) {
	      try {
	        set = __webpack_require__(43)(Function.call, __webpack_require__(73).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var isObject = __webpack_require__(36);
	var getPrototypeOf = __webpack_require__(81);
	var HAS_INSTANCE = __webpack_require__(48)('hasInstance');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var fails = __webpack_require__(30);
	var gOPN = __webpack_require__(72).f;
	var gOPD = __webpack_require__(73).f;
	var dP = __webpack_require__(34).f;
	var $trim = __webpack_require__(105).trim;
	var NUMBER = 'Number';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (!(TO_PRIMITIVE in proto)) __webpack_require__(33)(proto, TO_PRIMITIVE, __webpack_require__(182));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	$export($export.P + $export.F * (__webpack_require__(56) != Object || !__webpack_require__(192)(arrayJoin)), 'Array', {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	$export($export.P + $export.F * (fails(function () {
	  ...
	  test.sort(null);
	  // Old WebKit
	}) || !__webpack_require__(192)($sort)), 'Array', {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	'use strict';
	var $export = __webpack_require__(31);
	var $forEach = __webpack_require__(196)(0);
	var STRICT = __webpack_require__(192)([].forEach, true);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	'use strict';
	var $export = __webpack_require__(31);
	var $map = __webpack_require__(196)(1);

	$export($export.P + $export.F * !__webpack_require__(192)([].map, true), 'Array', {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	'use strict';
	var $export = __webpack_require__(31);
	var $filter = __webpack_require__(196)(2);

	$export($export.P + $export.F * !__webpack_require__(192)([].filter, true), 'Array', {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	'use strict';
	var $export = __webpack_require__(31);
	var $some = __webpack_require__(196)(3);

	$export($export.P + $export.F * !__webpack_require__(192)([].some, true), 'Array', {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	'use strict';
	var $export = __webpack_require__(31);
	var $every = __webpack_require__(196)(4);

	$export($export.P + $export.F * !__webpack_require__(192)([].every, true), 'Array', {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	$export($export.P + $export.F * !__webpack_require__(192)([].reduce, true), 'Array', {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	$export($export.P + $export.F * !__webpack_require__(192)([].reduceRight, true), 'Array', {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	$export($export.P + $export.F * (NEGATIVE_ZERO || !__webpack_require__(192)($native)), 'Array', {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(210)('copyWithin');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var $export = __webpack_require__(31);
	var $find = __webpack_require__(196)(5);
	var KEY = 'find';
	var forced = true;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var $export = __webpack_require__(31);
	var $find = __webpack_require__(196)(6);
	var KEY = 'findIndex';
	var forced = true;
	// Shouldn't skip holes
	if (KEY in []) Array(1)[KEY](function () { forced = false; });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// @@match logic
	__webpack_require__(224)('match', 1, function (defined, MATCH, $match) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// @@replace logic
	__webpack_require__(224)('replace', 2, function (defined, REPLACE, $replace) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// @@search logic
	__webpack_require__(224)('search', 1, function (defined, SEARCH, $search) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// @@split logic
	__webpack_require__(224)('split', 2, function (defined, SPLIT, $split) {
	  'use strict';
	  var isRegExp = __webpack_require__(157);
	  var _split = $split;
	  var $push = [].push;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var anObject = __webpack_require__(35);
	var isObject = __webpack_require__(36);
	var newPromiseCapability = __webpack_require__(234);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var anInstance = __webpack_require__(229);
	var forOf = __webpack_require__(230);
	var createArrayMethod = __webpack_require__(196);
	var $has = __webpack_require__(28);
	var validate = __webpack_require__(240);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(216)(ARRAY_BUFFER);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var gOPN = __webpack_require__(72).f;
	var dP = __webpack_require__(34).f;
	var arrayFill = __webpack_require__(212);
	var setToStringTag = __webpack_require__(47);
	var ARRAY_BUFFER = 'ArrayBuffer';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var $export = __webpack_require__(31);
	var getProto = __webpack_require__(81);
	var anObject = __webpack_require__(35);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(210)('includes');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var toLength = __webpack_require__(60);
	var aFunction = __webpack_require__(44);
	var arraySpeciesCreate = __webpack_require__(197);
	...
	__webpack_require__(210)('flatMap');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var toLength = __webpack_require__(60);
	var ctx = __webpack_require__(43);
	var IS_CONCAT_SPREADABLE = __webpack_require__(48)('isConcatSpreadable');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(210)('flatten');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var toLength = __webpack_require__(60);
	var isRegExp = __webpack_require__(157);
	var getFlags = __webpack_require__(220);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(29) && $export($export.P + __webpack_require__(294), 'Object', {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(51) || !__webpack_require__(30)(function () {
	  var K = Math.random();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var core = __webpack_require__(32);
	var microtask = __webpack_require__(233)();
	var OBSERVABLE = __webpack_require__(48)('observable');
	var aFunction = __webpack_require__(44);
	var anObject = __webpack_require__(35);
	var anInstance = __webpack_require__(229);
	var redefineAll = __webpack_require__(237);
...
/***/ (function(module, exports) {
	...
	exports.SignUpFormFloating = SignUpFormFloating;
	/**
	 * SignUpFormFloatingClass.
	 */
	var SignUpFormFloatingClass = {
	  CTA: 'driver-cta',
	...
	function SignUpFormFloating() {
	  var form_floating = document.getElementsByClassName(SignUpFormFloatingClass.FORM)[0];
	  var cta_floating = document.getElementsByClassName(SignUpFormFloatingClass.FIXED_CTA)[0];
	  var cross = document.querySelector(SignUpFormFloatingClass.CROSS);
	  var cross_path = document.querySelector(SignUpFormFloatingClass.CROSS + ' path');
	  var body = document.getElementsByTagName('body')[0];
	  var html = document.getElementsByTagName('html')[0];
	  var pos = 0;
	  var overlay = document.getElementsByClassName(SignUpFormFloatingClass.OVERLAY)[0];
	  var isFloatEnabled = cta_floating.getAttribute("data-isFloatFormEnabled");
	  var bodyTag = document.getElementsByTagName('body')[0];
	  var isFormOpenedOnce = false;
	  var signupFormSrollContent = document.getElementsByClassName(SignUpFormFloatingClass.SIGNUP_FORM_SCROLLABLE_AREA)[0];
	  ...
	  function initialSetup() {
	    ...
	    if (!isMapApiIncluded) {
	      ...
	      scriptTag.src = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyDw2kzk7w6Qquegqreg2CaiKmFUyMKO1FM' + '&libraries=places&callback=initAutoCompleteSignUpFloating';
...
/***/ (function(module, exports) {
	...
	function activeNav() {
	  var bodyClass = document.getElementsByTagName('body')[0].getAttribute('nav-menu');
	  var navEl = document.getElementsByClassName('nav__tabs')[0];

	  //Check if page has navigation
	  if (navEl) {
	    if (bodyClass) {
	      var navAttr = navEl.getElementsByTagName('a');

	      for (var i = 0; i < navAttr.length; i++) {
	        var navAttrClass = navAttr[i].getAttribute('data-track1');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _formatNumber = __webpack_require__(378);
	...
	function Form() {
	  ...
	  var checkValidations = function () {
	    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
	      var isValidData, userData, userInputobj, value, inputEls, latEl, lngEl, _i4, emailStatus, url, queryStringObj, xhttp;
	        ...
	        while (1) {
	          switch (_context.prev = _context.next) {
	            case 0:
	              ...
	              userInputobj = JSON.parse(userData);
	              value = phoneEl.value.replace(/\D/g, '');
	              inputEls = document.querySelectorAll('.intro__field');
	              latEl = document.getElementById('lat');
	              lngEl = document.getElementById('lng');
	              _i4 = 0;

	            case 9:
	              if (!(_i4 < inputEls.length)) {
	                _context.next = 28;
	                break;
	              }

	              if (!(inputEls[_i4].value === '' && inputEls[_i4].id != 'code' && inputEls[_i4].id != 'region')) {
	                _context.next = 15;
	                break;
	              }

	              addErrClass(inputEls[_i4]);
	              isValidData.push(false);
	              _context.next = 23;
	              break;

	            case 15:
	              if (!(inputEls[_i4].id == 'email')) {
	                _context.next = 22;
	                break;
	              }

	              _context.next = 18;
	              return checkValidEmail(inputEls[_i4]);
	            ...
	            case 18:
	              ...
	              if (!emailStatus) {
	                ...
	                userInputobj[inputEls[_i4].name] = inputEls[_i4].value;
	              }
	              _context.next = 23;
	              break;

	            case 22:
	              if (inputEls[_i4].id == 'region') {

	                // Validation whether region selected from maps api.
	                if (window.isCitySelected && window.cityName === inputEls[_i4].value) {
	                  //userInputobj[inputEls[i].name] = inputEls[i].value;
	                  userInputobj[latEl.name] = latEl.value;
	                  userInputobj[lngEl.name] = lngEl.value;
	                } else {
	            ...
	            case 23:
	              inputEls[_i4].addEventListener('keyup', watchInput);
	              inputEls[_i4].addEventListener('keydown', function () {
	                clearTimeout(typeingTimer);
	              });
	  ...
	  var inputEls = document.getElementsByClassName('intro__field');
	  var nextBtn = document.getElementsByClassName('intro__btn-next')[0];
	  var phoneEl = document.getElementById('phone');
	  var agreeTermsEl = document.getElementsByClassName('intro__agree')[0];
	  var submitBtn = document.getElementsByClassName('intro__btn-submit')[0];
	  var checkBoxEl = document.getElementById('agree-terms');
	  var phoneField = document.getElementById('phone');
	  var telNumber = 0;
	  var phonePixelFired = false;
	  var emailObj = {};
	  var typeingTimer = void 0;
	  ...
	  new _formatNumber.formatNumber(phoneEl);

	  /**
	   * Fires pixel when user enters phone nunber
	   */
	  function handleKeyPress(e) {
	    var char = phone.value.length;
	    if (!phonePixelFired) {
	      if (char != 0 && char >= 1) {
	  ...
	  function verifyNumber(e) {
	    e.preventDefault();
	    var inputNo = phoneEl.value.replace(/\D/g, '');
	    ...
	    for (var _i = 0; _i < inputEls.length; _i++) {
	      if (inputEls[_i].value !== "") {
	        var _label = inputEls[_i].previousSibling;
	        _label.classList.add(FormClasses.LABEL);
	      }
	    }
	  }
	  ...
	  function handleResponse(response) {
	    if (response) {
	      var otherFormDetails = document.getElementsByClassName('js-form');
	      var titleHeader = document.getElementsByClassName('intro__title')[0];
	      var bodyTag = document.getElementsByTagName('body')[0];
	      var scriptTag = document.createElement('script');
	      var termsEl = document.getElementsByClassName('js-terms')[0];
	      var appliedEl = document.getElementsByClassName('js-applied')[0];
	      var scriptTags = document.getElementsByTagName("script");
	      var isMapApiIncluded = false;
	      ...
	      for (var _i2 = 0; _i2 < scriptTags.length; _i2++) {
	        if (/https:\/\/maps\.googleapis\.com/.test(scriptTags[_i2].getAttribute("src"))) {
	          isMapApiIncluded = true;
	        }
	      }
	      // Lazy loading of maps api.
	      if (!isMapApiIncluded) {
	        scriptTag.src = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyDw2kzk7w6Qquegqreg2CaiKmFUyMKO1FM' + '&libraries=places&callback=initAutoComplete';
	        bodyTag.appendChild(scriptTag);
	      }
	      ...
	      for (var _i3 = 0; _i3 < otherFormDetails.length; _i3++) {
	        otherFormDetails[_i3].style.display = 'block';
	      }
	      nextBtn.style.display = 'none';
	      submitBtn.style.display = 'block';

	      //<!-- Ampush/Safari Tracker Pixel Code -->
	      var initiative = void 0;
	      var pid = void 0;
	      ...
	      !function () {
	        ...
	        'undefined' != typeof t && document.getElementsByTagName('head')[0].appendChild(t);
	        t.onload = function () {
	          ampt.init('lyft', 'ce4c0c2b8-3c40-4963-9164-198a13f7689e');ampt.pageview(utmAPI.default.getUtmParams());ampt.track('Apply2', utmAPI.default.getUtmParams());safariAmpt.init(pid, initiative);safariAmpt.track('applytwopageview', utmAPI.default.getUtmParams());
	        };
	      }();
...
/***/ (function(module, exports) {
	 ...
	 * @private {string}
	 */
	var ERROR_CLASS = 'intro__field--err';
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 * @private {string}
	 */
	var CLASS_CTA_DISABLED = 'block__cta--disabled';

	/**
	 * Handles verification code functionality.
	 */
	function verifyNumber() {
	  var phoneNoDisplayEl = document.getElementById('phone-no');
	  var resendCodeEl = document.getElementsByClassName('js-resend')[0];
	  var verifyCodeInputEl = document.getElementsByClassName('block__verify-code')[0];
	  var verificationBlockEl = document.getElementsByClassName('block__verification-code')[0];
	  var resendBlockEl = document.getElementsByClassName('block__resend-verification-code')[0];
	  var phoneNoInputEl = document.getElementsByClassName('block__resend-verify')[0];
	  var errorMsgEl = document.getElementsByClassName('block__form-error')[0];
	  var secondNextBtn = document.getElementById('next-2');
	  var firstNextBtn = document.getElementById('next-1');

	  var queryString = location.search.substr(1);
	  var decodedString = unescape(decodeURI(queryString));
	  var verifyNo = decodedString.split('&')[0].split('=')[1];
	  ...
	  new _formatNumber.formatNumber(phoneNoInputEl);
	  ...
	  function getVerificationCode(e) {
	    e.preventDefault();
	    var inputNo = phoneNoInputEl.value.replace(/\D/g, '');
	    var phoneNo = {
	      'phone': inputNo
	    };
	  ...
	  function verifyCode(e) {
	    ...
	    if (e.target.value.length == 4) {
	      ...
	      // API call to check valid number.
	      var xhttp = new XMLHttpRequest();
	      xhttp.open('GET', 'https://apv.ampush.io/api/confirm/' + verifyNo.replace(/\D/g, '') + '/' + e.target.value, true);
	      xhttp.onload = function () {
	        if (xhttp.status == 200) {
	          if (JSON.parse(xhttp.response).success) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.questionsAccordian = questionsAccordian;
	 ...
	 */
	function questionsAccordian() {
	  var accEl = document.getElementsByClassName(AccordianClasses.ACCORDIAN_QUESTION);
	  var panel = document.getElementsByClassName(AccordianClasses.ACCORDIAN_ANSWER_OPEN)[0];
	  var allPanel = document.getElementsByClassName(AccordianClasses.ACCORDIAN_ANSWER);
	  var isFirstAccordionClick = true;
	  ...
	  function updateHeightOfAllPanel() {
	    ...
	    if (window.innerWidth > 480) {
	      for (var _i = 0; _i < allPanel.length; _i++) {
	        allPanel[_i].style.maxHeight = allPanel[_i].scrollHeight + 'px';
	      }
	    } else {
	      for (var _i2 = 0; _i2 < allPanel.length; _i2++) {
	        if (!allPanel[_i2].classList.contains(AccordianClasses.ACCORDIAN_ANSWER_OPEN)) allPanel[_i2].style.maxHeight = 0;else allPanel[_i2].style.maxHeight = allPanel[_i2].scrollHeight + 'px';
	      }
	    }
	  }
	  /**
	  ...
	  function toggle(e) {
	    ...
	    var openEl = document.getElementsByClassName(AccordianClasses.ACCORDIAN_CONTAINER_OPEN)[0];
	    var openAnsEl = document.getElementsByClassName(AccordianClasses.ACCORDIAN_ANSWER_OPEN)[0];
	    var panel = null;
	    var parentEl = null;
	    ...
	    if (e.target.classList.contains(AccordianClasses.ACCORDIAN_CONTAINER_OPEN) || e.target.parentElement.classList.contains(AccordianClasses.ACCORDIAN_CONTAINER_OPEN)) {
	      isAlreadyOpen = true;
	    }
	    //finding previous opened and currently clicked element
	    for (var _i3 = 0; _i3 < allPanel.length; _i3++) {
	      if (allPanel[_i3] == openAnsEl) prev = _i3;
	      if (allPanel[_i3] == e.target.nextSibling) curr = _i3;
	    }
	  ...
	  function setPositionToTop(e, offsetOfOpenedElement) {
	    ...
	    var whereToScroll = e.target.parentElement.parentElement.id;
	    if (offsetOfOpenedElement == "0") (0, _jump.jump)("#" + whereToScroll, { duration: 300, offset: offsetOfOpenedElement });else (0, _jump.jump)("#" + whereToScroll, { duration: 300, offset: -offsetOfOpenedElement });
	  }
	}
...
/***/ (function(module, exports) {
	...
	function countDownTimer() {
	  ...
	  function scrollFunctionTimer() {
	    var offset = document.getElementsByClassName("full-hero")[0].scrollHeight - 50;
	    var ctaBottom = document.getElementsByClassName("js-cta")[0];
